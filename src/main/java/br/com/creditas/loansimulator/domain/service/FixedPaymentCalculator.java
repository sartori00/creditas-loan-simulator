...
public class FixedPaymentCalculator {
    ...
    public BigDecimal calculate(BigDecimal monthlyRate, BigDecimal valueForLoan, int installments) throws IllegalArgumentException {
    ...
    private void validateParams(BigDecimal monthlyRate, BigDecimal valueForLoan, int installments) throws IllegalArgumentException{
