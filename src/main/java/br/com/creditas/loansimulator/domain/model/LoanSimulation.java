...
public class LoanSimulation {
  ...
  public LoanSimulation(
      Currency currency, BigDecimal loanAmount, int qtInstallments, Person person) {
  ...
  public BigDecimal getTotalAmountToPay() {
    return this.installmentAmount
        .multiply(new BigDecimal(this.qtInstallments))
  ...
  public BigDecimal getTotalInterest() {
    return this.getTotalAmountToPay().subtract(this.loanAmountBRL).setScale(2, RoundingMode.UP);
  }
