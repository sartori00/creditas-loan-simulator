...
public class FirstRangeStrategy implements RangesStrategy {

    private static final int RANGE_FINAL = 25;
    private static final BigDecimal ONE_YEAR = new BigDecimal(12);
    private final BigDecimal rateRange;


    public FirstRangeStrategy(RateRanges rateRanges) {
        rateRange = rateRanges.getFirstRateRange();
    }

    @Override
    public boolean isThisRange(int age){
        return age <= RANGE_FINAL;
    }
